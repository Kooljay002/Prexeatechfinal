    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.pexels.com/photos/3760067/pexels-photo-3760067.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`
          }}
        />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 text-center pt-40 pb-24">
        ...
        >
          ...
          <h1 className="font-heading text-4xl md:text-6xl lg:text-7xl text-soft-white mb-6 leading-tight">
            Build Something That<br />Lasts in Africa
          </h1>
          <p className="text-xl text-soft-white/80 max-w-3xl mx-auto leading-relaxed">
            Whether you are a technology developer, investor, research institution,
            or government body — there is a Prexea partnership model designed for you.
          </p>
        </motion.div>
      </div>
    </section>
