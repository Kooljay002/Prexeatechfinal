    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.pexels.com/photos/261763/pexels-photo-261763.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`
          }}
        />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 text-center pt-40 pb-24">
        ...
        >
          ...
          <p className="text-xl text-soft-white/80 max-w-3xl mx-auto leading-relaxed">
            Deep dives on African agritech, technology commercialisation,
            food security, and sustainable enterprise from the Prexea team.
          </p>
        </motion.div>
      </div>
    </section>
