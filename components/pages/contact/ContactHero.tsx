    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.pexels.com/photos/380768/pexels-photo-380768.jpeg?auto=compress&cs=tinysrgb&w=1920&h=1080&fit=crop')`
          }}
        />
      ...
      <div className="relative z-10 max-w-3xl mx-auto px-6 sm:px-10 text-center pt-40 pb-24">
        ...
        >
          ...
          <p className="text-xl text-soft-white/80 max-w-3xl mx-auto leading-relaxed">
            Whether you have a specific project, a technology to commercialise,
            or just want to explore possibilities &mdash; our team is ready to listen.
          </p>
        </motion.div>
      </div>
    </section>
